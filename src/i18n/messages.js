...
export const messages = {
    [LOCALES.RUSSIAN]: {
        ...
        smokers_lung_cancer: 'Люди, не имеющие симптомы заболевания и имеющие малые симптомы заболевания бронхолегочной системы старше 40 лет, а также курильщики, чей стаж курения больше 20 лет (выкуривающие 1 пачку в день в течение 20 лет или по 2 пачки в день в течение 10 лет).',
        ...
        standart_procedure_liver_cancer: 'На сегодняшний день стандартной процедурой скрининга у групп высокого риска является: 1)ультразвуковое исследование (УЗИ) печени; 2) определение онкомаркера (АФП).',
        ...
        cervix_data1_text6: 'При значительном распространении опухоли появляются боли, нарушения мочеиспускания и затруднения при акте дефекации.',
        ...
        prostate_data1_text1_column2: '1. Исследование крови - скрининг на сывороточный уровень простат-специфического антигена (ПСА). Обычно скрининг проводится у мужчин 50 лет, но иногда скрининг начинают раньше у мужчин с высоким риском развития заболевания (например, с семейным анамнезом рака простаты);',
        ...
        breast_data1_text3_column2: 'ограниченная подвижность либо полное её отсутствие, как правило, безболезненность опухоли, наличие втяжения кожи над опухолью;',
        ...
        breast_data1_text3_column3: 'ограниченная подвижность либо полное её отсутствие, как правило, безболезненность опухоли, наличие втяжения кожи над опухолью;',
        ...
        gut_data1_text1: 'У 3–5 % больных развитие колоректального рака связано с наличием известных наследственных синдромов, наиболее распространенные из которых – синдром Линча, семейный аденоматоз толстой кишки и MutYH-ассоциированный полипоз. У остальных пациентов колоректальный рак носит случайный характер.',
        ...
        result_survey_modal2: 'Вы находитесь в высокой группе риска возникновения заболевания. Это может означать, что у Вас имеется ряд факторов риска, которые могут вызвать развитие рака. Поэтому Вам необходимо пройти обследование.',
    ...
    [LOCALES.SAKHA]: {
        ...
        standart_procedure_liver_cancer: 'Күн бүгүн стандарт процедуратынан үрдүк уруһуйдаах бөлөх баар: 1)ультазвованнай чинчийии (УЗИ) быары; 2) онкаркер (АФП) билгэлээһин.',
        ...
        prostate_data1_text1_column2: '1. Хаан анаалыһа - простат-специфическэй антиген (ПСА) хааҥҥа таһымын чинчийии. Скрининг 50 саастарын туолбут эр дьоҥҥо оҥоһуллар, ол эрээри сороҕор кутталлаах бөлөххө киирэр сорох дьонтон (холобур,  дьиэ кэргэннэригэр оннук ыарыы кимиэхэ эрэ диагностана сылдьыбыт түгэнигэр) эмиэ ылаллар;',
        ...
        result_survey_modal2: 'Эһиги ыарыы үөскүүрүгэр кутталлаах, үрдүкү бөлөххө бааргыт. Ол аата рак сайдыытын ыҥырар кэккэҕэ элбэх фаактордаахыт диэххэ  сөп. Онон чинчийиини ааһыаххыт наада.',
